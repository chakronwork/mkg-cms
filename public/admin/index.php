...
$router->add('GET', '/admin/hero-slides', 'AdminHeroSlideController', 'index');
$router->add('POST', '/admin/hero-slides', 'AdminHeroSlideController', 'save');
$router->add('POST', '/admin/hero-slides/{id}/delete', 'AdminHeroSlideController', 'delete');
